...
%>
<SCRIPT LANGUAGE="JavaScript" src="<%=urlPath%>/sy/util/office/redHeadAuth.js"></script>
<script LANGUAGE="JavaScript" src="<%=urlPath%>/sy/util/office/fileOperator.js"></script>
<center>
