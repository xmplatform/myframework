...
<head>
   ...
   <%@ include file= "/sy/base/view/inHeader.jsp" %>
    <script type="text/javascript" src="<%=urlPath%>/sy/base/frame/coms/all/ui.all.js"></script>
 	<link rel="stylesheet" type="text/css" href="<%=urlPath%>/sy/base/frame/coms/all/style.css" />
</head>
<%
