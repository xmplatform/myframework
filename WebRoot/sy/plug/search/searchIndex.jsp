...
<script src="<%=contextPath%>/sy/plug/search/search.js" type=text/javascript></script>
<script src="<%=contextPath%>/sy/plug/search/suggest.js" type=text/javascript></script>
<%
