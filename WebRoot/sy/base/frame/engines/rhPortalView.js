...
//	} else {
		...
		this._searchIcon = jQuery("<img src='" + FireFly.getContextPath() + "/sy/comm/page/img/bannericon.png' title='点击查询' width='18px' height='18px' style='cursor:pointer;margin-bottom:-5px;'/>").appendTo(searchDiv);
