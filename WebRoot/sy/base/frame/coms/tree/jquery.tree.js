...
(function($) {
    ...
    $.fn.treeview = function(settings) {    	
        ...
        function builparam(node) {
            ...
            p.push(param2);
            var param3 = {};
            param3["name"] = "_extWhere";
            param3["value"] = dfop.extWhere ? dfop.extWhere : "";
            p.push(param3);
            var param4 = {};
            param4["name"] = "PID";
            param4["value"] = node.ID;
            p.push(param4);
            var param5 = {};
            param5["name"] = "NAME";
            param5["value"] = node.NAME;
            p.push(param5);
            var param6 = {};
            param6["name"] = "checkstate";
            param6["value"] = node.checkstate;
            p.push(param6);
            return p;
        }
