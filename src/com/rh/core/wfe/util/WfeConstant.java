...
public class WfeConstant {
	 ...
	 * 流程未办结
	 */
	public static final int WFE_PROC_INST_IS_RUNNING = 1;
	
	/**
	 * 流程已经办结
	 */
	public static final int WFE_PROC_INST_NOT_RUNNING = 2;
	 ...
	 * 节点办理类型 收回
	 */
	public static final String NODE_DONE_TYPE_WITHDRAW_DESC = "收回";
