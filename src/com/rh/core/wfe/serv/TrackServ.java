...
public class TrackServ extends CommonServ {
        ...
        for (Bean niBean : dataList) {
            ...
            if (niBean.isEmpty("TO_USER_ID")) { //还没设置上，这个是肯定多人的
                ...
                for (Bean nodeUser: nodeUsers) {
                    String toUserName = createUserLink(nodeUser, "TO_USER_NAME", "TO_USER_ID");
                ...
                niBean.set("DONE_USER_NAME", createUserLink(niBean, "TO_USER_NAME", "TO_USER_ID"));
            } else {
                String toUserName = createUserLink(niBean, "TO_USER_NAME", "TO_USER_ID");
                String doneUser = createUserLink(niBean, "DONE_USER_NAME", "DONE_USER_ID");
            ...
            if (preNode != null) {
                ...
                if (preNode.isEmpty("DONE_USER_NAME")) { // 如果前一个节点未结束
                    niBean.set("TO_USER_NAME", createUserLink(preNode, "TO_USER_NAME", "TO_USER_ID"));
                } else {
                    niBean.set("TO_USER_NAME", createUserLink(preNode, "DONE_USER_NAME", "DONE_USER_ID"));
                }
            } else {
     ...
     */
    private String createUserLink(Bean niBean, String nameItem, String userItem) {
